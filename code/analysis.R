...
cpue_station <- 
  ...
  dplyr::select(any_of(
    ...
    species_code, itis, common_name, scientific_name, taxon_confidence,  itis, worms, # species info
...
save(cpue_station, cpue_station_0filled,
     file = paste0(dir_out,"cpue_station"))
