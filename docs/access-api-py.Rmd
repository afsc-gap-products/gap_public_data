...
Note that, in this example, only records with Pacific cod are included ("presence-only" data). See zero catch inference below. In other words, it reports on CPUE only for hauls in which Pacific cod were recorded, excluding some hauls like those in which Pacific cod were not found at all.
