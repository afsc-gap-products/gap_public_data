...
```
    ...
    ##  [1] RODBC_1.3-19   jsonlite_1.8.3 httr_1.4.4     knitr_1.41     badger_0.2.2   stringr_1.4.1  taxize_0.9.100 janitor_2.1.0  here_1.0.1     rmarkdown_2.18 readr_2.1.3   
    ## [12] magrittr_2.0.3 dplyr_1.0.10   tidyr_1.2.1   
    ## 
