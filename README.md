...
>   - [*Select all data*](#select-all-data)
>   - [*Subset data*](#subset-data)
>   - [*If this file is too large, you can join catch and haul
>     data*](#if-this-file-is-too-large,-you-can-join-catch-and-haul-data)
...
oracle on **January 07, 2023**. *This is not the date that these data
...
These data were last updated January 07, 2023.
...
### If this file is too large, you can join catch and haul data

Pull the `RACEBASE_FOSS.JOIN_FOSS_CPUE_COMB`,
...
The JOIN_FOSS_CPUE_COMB (a reference dataset of standard stations to
which the following tables will be joined to), JOIN_FOSS_CPUE_CATCH
(join using HAULJOIN, SPECIES_CODE), JOIN_FOSS_CPUE_HAUL (using YEAR,
HAULJOIN) datasets need to be full joined to create zero-filled
(presence and absence) observations and catch-per-unit-effort (CPUE)
estimates for all identified species at a standard set of stations in
the Northern Bering Sea (NBS), Eastern Bering Sea (EBS), Bering Sea
Slope (BSS), Gulf of Alaska (GOA), and Aleutian Islands (AI) Surveys
conducted by the esource Assessment and Conservation Engineering
...
These data were last updated January 07, 2023.
    ...
    ## RACEBASE_FOSS.JOIN_FOSS_CPUE_COMB: 
    ##   rows: 36308030
    ##   cols: 3
    ##   NA GB
...
```
    ...
    ##  [1] RODBC_1.3-20   jsonlite_1.8.4 httr_1.4.4     knitr_1.41     badger_0.2.2   stringr_1.5.0  taxize_0.9.100
    ##  [8] janitor_2.1.0  here_1.0.1     rmarkdown_2.19 readr_2.1.3    magrittr_2.0.3 dplyr_1.0.10   tidyr_1.2.1   
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] bit64_4.0.5         vroom_1.6.0         foreach_1.5.2       bold_1.2.0          assertthat_0.2.1   
    ##  [6] askpass_1.1         highr_0.9           BiocManager_1.30.19 rvcheck_0.2.1       yulab.utils_0.0.5  
    ## [11] cellranger_1.1.0    yaml_2.3.6          pillar_1.8.1        lattice_0.20-45     glue_1.6.2         
    ## [16] uuid_1.1-0          digest_0.6.31       RColorBrewer_1.1-3  snakecase_0.11.0    colorspace_2.0-3   
    ## [21] htmltools_0.5.4     plyr_1.8.8          pkgconfig_2.0.3     httpcode_0.3.0      gitcreds_0.1.2     
    ## [26] purrr_0.3.5         scales_1.2.1        tzdb_0.3.0          openssl_2.0.5       timechange_0.1.1   
    ## [31] tibble_3.1.8        generics_0.1.3      ggplot2_3.4.0       usethis_2.1.6       ellipsis_0.3.2     
    ## [36] withr_2.5.0         credentials_1.3.2   cli_3.4.1           crayon_1.5.2        readxl_1.4.1       
    ## [41] evaluate_0.19       fs_1.5.2            fansi_1.0.3         nlme_3.1-161        xml2_1.3.3         
    ## [46] gh_1.3.1            tools_4.2.2         data.table_1.14.6   hms_1.1.2           lifecycle_1.0.3    
    ## [51] gert_1.9.2          munsell_0.5.0       compiler_4.2.2      rlang_1.0.6         grid_4.2.2         
    ## [56] conditionz_0.1.0    sys_3.4.1           iterators_1.0.14    rstudioapi_0.14     gtable_0.3.1       
    ## [61] codetools_0.2-18    DBI_1.1.3           reshape_0.8.9       curl_4.3.3          readtext_0.81      
    ## [66] R6_2.5.1            zoo_1.8-11          lubridate_1.9.0     fastmap_1.1.0       bit_4.0.5          
    ## [71] utf8_1.2.2          rprojroot_2.0.3     dlstats_0.1.6       ape_5.6-2           stringi_1.7.8      
    ## [76] parallel_4.2.2      crul_1.3            Rcpp_1.0.9          vctrs_0.5.1         tidyselect_1.2.0   
    ## [81] xfun_0.35
