...
## Obtain data interactively through the [Fisheries One Stop Shop (FOSS)](`r link_foss `) platform
...
<img src="img/_grid_bs.png" alt="Eastern and Northern Bering Sea Shelf" width="400"/> <img src="img/_grid_ai.png" alt="Aleutian Islands" width="500"/>
...
If you feel that the data or metadata can be improved, please create a pull request, [submit an issue to the GitHub organization](`r "https://github.com/afsc-gap-products/data-requests/issues"`), [submit an issue to the code's repository](`r paste0(link_repo, "/issues")`), reach out the the survey team leads (listed below), or to [Fisheries One Stop Shop (FOSS)](`r link_foss `) platform managers.
