...
", round(file.size(paste0(dir_out, "cpue_station.csv"))/1e+9, 3), " GB

RACEBASE_FOSS.FOSS_ZEROFILLED: ", "
rows: ", nrow(cpue_station_0filled_clean), "
cols: ", ncol(cpue_station_0filled_clean), "
", round(file.size(paste0(dir_out, "cpue_station_0filled_clean.csv"))/1e+9, 3), " GB
